-- Clean all simulated data from health-related tables
...
DELETE FROM marketplace_bundles WHERE bundle_id LIKE 'health_%' OR title LIKE '%Health%' OR title LIKE '%HealthKit%';
...
TRUNCATE staged_health_data RESTART IDENTITY CASCADE;
TRUNCATE raw_health_data RESTART IDENTITY CASCADE;
