...
// Public-mapping auto-getter generated by Solidity for `deployedPools` on IDIAPoolFactory.
const REGISTRY_ABI = [
  {
    name: "deployedPools",
    type: "function",
...
serve(async (req: Request) => {
  ...
  try {
    ...
    console.info(`[BEGIN: Registry.deployedPools] location=${executionLocation}`);
    ...
    console.info(`[END: Registry.deployedPools] resolved=${poolTarget}`);
