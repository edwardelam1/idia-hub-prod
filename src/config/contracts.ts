 ...
 *
 * KEEP IN SYNC WITH: supabase/functions/_shared/contracts.ts
 *
...
// ─── PRODUCTION LOCK ────────────────────────────────────────────────
// The protocol is LIVE on Base Mainnet (Chain ID 8453). DO NOT flip
// this toggle on production branches and DO NOT zero-out mainnet.
