    ...
    switch (bundleIdNumber) {
      ...
      case 6: // Urban Wellness Bundle - Using REAL data
        ...
        const realWellnessData = [
          ...
          { urbanZone: 'UrbanZone2', avgDailySteps: '8,761', activeCalories: '424 kcal', popularActivity: 'Walking', peakActivityTime: '5:00-7:00 PM', sleepDuration: '8.7 hours', heartRateZone: 'Peak (70-85%)', workoutFrequency: 'Rarely' },
