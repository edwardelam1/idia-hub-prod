  ...
  return (
    ...
    <div className="space-y-6 min-w-0">
      <div className="flex items-start gap-2 mb-6">
        ...
        <div>
          <h2 className="text-xl sm:text-2xl font-bold">Data Vault Feeds</h2>
          <p className="text-sm text-muted-foreground">Subscribe to real-time streams generated by the AI Synapse engine.</p>
        </div>
      </div>
              ...
              <CardContent>
                <div className="flex flex-wrap items-center gap-2 sm:gap-4 mb-4 text-sm">
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <span tabIndex={0}>
                        <Badge variant="outline" className="bg-muted max-w-full whitespace-normal break-all text-left">Topic: <code className="ml-1 text-primary">{feed.topic}</code></Badge>
                      </span>
                    </TooltipTrigger>
                ...
                <div className="bg-slate-950 rounded-lg p-3 h-[140px] overflow-y-auto overflow-x-hidden font-mono text-[11px] sm:text-xs">
                  {!isActive ? (
