      ...
      <Tabs value={rail} onValueChange={(v) => setRail(v as 'tradfi' | 'defi')} className="space-y-6">
        ...
        <TabsContent value="defi" className="space-y-6 mt-0">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 bg-card border border-border rounded-2xl p-8 flex flex-col justify-between shadow-xl">
              <div>
                <span className="text-muted-foreground text-xs font-bold uppercase tracking-widest">On-Chain USDC Balance</span>
            ...
            <div className="bg-card border border-border rounded-2xl p-6 flex flex-col justify-between">
              <div>
                ...
                <p className="text-[10px] text-muted-foreground leading-relaxed">
                  On-chain settlements move <strong>USDC</strong> directly to your self-custodied wallet.
                  Balances are read live from Base mainnet contracts.
                </p>
              </div>
              {walletAddress ? (
                <a
