        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Your identity is verified and managed through the Life by IDIA mobile application. No personal
                information is stored in the Hub database.
              </CardDescription>
            </div>
            <Badge variant="outline" className="border-primary/30 bg-primary/5 text-primary gap-1.5">
              <ShieldCheck className="h-3 w-3" />
              {isFromSecureEnclave ? "Secure Enclave" : "Verified via Life by IDIA"}
            </Badge>
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input value={displayName} disabled className="bg-muted/20 text-foreground cursor-not-allowed" />
            </div>
            <div className="space-y-2">
              <Label className="text-muted-foreground text-xs uppercase tracking-wider">Email</Label>
              <Input value={email} disabled className="bg-muted/20 text-foreground cursor-not-allowed" />
            </div>
            <div className="space-y-2">
              ...
              <Input
                value={
                  typeof platformGuid === "string" && platformGuid.length > 12
            ...
            <div className="flex items-center gap-2 flex-wrap text-xs">
              {termsAccepted && acceptedDisplay ? (
                <>
                  ...
                  <span className="text-muted-foreground font-mono">v{termsVersion || TERMS_VERSION}</span>
                </>
              ) : (
