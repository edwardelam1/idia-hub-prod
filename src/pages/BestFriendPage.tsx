    ...
    <ErrorBoundary>
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-200 flex-shrink-0">
            ...
            <div>
                ...
                <p className="text-[10px] uppercase tracking-widest text-muted-foreground font-bold font-mono">Agentic Orchestration Layer</p>
            </div>
            </div>
        ...
        <div className="pt-4 border-t border-border max-w-3xl mx-auto w-full space-y-4">
            ...
            <div className="text-[9px] text-muted-foreground font-mono font-bold uppercase opacity-50">Tell Your Best Friend Everything...</div>
            </div>
        </div>
        </div>
    </ErrorBoundary>
