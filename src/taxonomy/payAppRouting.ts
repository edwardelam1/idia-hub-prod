...
export const PAY_APP_ROUTING: Record<string, SubModuleRoute> = {
  ...
  // ── Hospitality ──
  'hosp-fine-dining': { subModuleId: 'hosp-fine-dining', name: "Fine Dining", verticalId: 'hospitality', industryId: 'tertiary.hospitality.fine_dining', components: ["default-pos","default-menu","default-recipes","default-inventory","default-reports","default-team","default-timesheets"] },
  'hosp-diner': { subModuleId: 'hosp-diner', name: "Diner", verticalId: 'hospitality', industryId: 'tertiary.hospitality.diner', components: ["default-pos","default-menu","default-recipes","default-inventory","default-reports","default-team","default-timesheets"] },
  'hosp-hotel': { subModuleId: 'hosp-hotel', name: "Hotel", verticalId: 'hospitality', industryId: 'tertiary.hospitality.lodging', components: ["default-pos","default-menu","default-recipes","default-inventory","default-reports","default-team","default-timesheets"] },
  'hosp-home': { subModuleId: 'hosp-home', name: "Home Services", verticalId: 'hospitality', industryId: 'tertiary.hospitality.home_services', components: ["default-pos","default-menu","default-recipes","default-inventory","default-reports","default-team","default-timesheets"] },
  'hosp-theme-park': { subModuleId: 'hosp-theme-park', name: "Theme Park", verticalId: 'hospitality', industryId: 'tertiary.hospitality.theme_park', components: ["default-pos","default-menu","default-recipes","default-inventory","default-reports","default-team","default-timesheets"] },
  'hosp-cafe': { subModuleId: 'hosp-cafe', name: "Café & Bakery", verticalId: 'hospitality', industryId: 'tertiary.hospitality.cafe_bakery', components: ["default-pos","default-menu","default-recipes","default-inventory","default-reports","default-team","default-timesheets"] },
  'hosp-bar': { subModuleId: 'hosp-bar', name: "Bar & Lounge", verticalId: 'hospitality', industryId: 'tertiary.hospitality.bar_nightlife', components: ["default-pos","default-menu","default-recipes","default-inventory","default-reports","default-team","default-timesheets"] },
  'hosp-catering': { subModuleId: 'hosp-catering', name: "Catering", verticalId: 'hospitality', industryId: 'tertiary.hospitality.catering', components: ["default-pos","default-menu","default-recipes","default-inventory","default-reports","default-team","default-timesheets"] },
  // ── Logistics ──
  ...
  'fb-food-truck': { subModuleId: 'fb-food-truck', name: "Food Truck", verticalId: 'foodbev', industryId: 'secondary.foodbev.food_truck', components: ["default-inventory","default-warehouse-receiving","default-warehouse-counting","default-warehouse-shipping","default-reports","default-team"] },
};
