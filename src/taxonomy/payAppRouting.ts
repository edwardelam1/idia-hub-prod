...
export const PAY_APP_ROUTING: Record<string, SubModuleRoute> = {
  ...
  'hosp-cafe': { subModuleId: 'hosp-cafe', name: "Café & Bakery", verticalId: 'hospitality', industryId: 'tertiary.hospitality.caf_bakery', components: ["default-pos","default-menu","default-recipes","default-inventory","default-reports","default-team","default-timesheets"] },
