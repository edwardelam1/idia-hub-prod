...
export const PAY_APP_ROUTING: Record<string, SubModuleRoute> = {
  ...
  // ── Hospitality ──
  'hosp-fine-dining': { subModuleId: 'hosp-fine-dining', name: "Fine Dining", verticalId: 'hospitality', industryId: 'tertiary.hospitality.fine_dining', components: ["nb-hosp-server", "nb-hosp-kds-routing", "nb-hosp-billing"] },
  'hosp-diner': { subModuleId: 'hosp-diner', name: "Diner", verticalId: 'hospitality', industryId: 'tertiary.hospitality.diner', components: ["nb-hosp-server", "nb-hosp-kds-routing", "nb-hosp-billing"] },
  ...
  'hosp-catering': { subModuleId: 'hosp-catering', name: "Catering", verticalId: 'hospitality', industryId: 'tertiary.hospitality.catering', components: ["nb-hosp-server", "nb-hosp-kds-routing"] },
  'hosp-kds': { subModuleId: 'hosp-kds', name: "KDS Routing", verticalId: 'hospitality', industryId: 'tertiary.hospitality', components: ["nb-hosp-kds-routing"] },
  'hosp-housekeeping-inv': { subModuleId: 'hosp-housekeeping-inv', name: "Housekeeping Inventory", verticalId: 'hospitality', industryId: 'tertiary.hospitality.lodging', components: ["nb-hosp-inventory"] },
  ...
  'hosp-cmms': { subModuleId: 'hosp-cmms', name: "CMMS Work Orders", verticalId: 'hospitality', industryId: 'tertiary.hospitality', components: ["nb-hosp-inventory"] },
  'hosp-life-safety': { subModuleId: 'hosp-life-safety', name: "Life Safety Compliance", verticalId: 'hospitality', industryId: 'tertiary.hospitality', components: ["nb-system-security"] },
  // ── Logistics ──
