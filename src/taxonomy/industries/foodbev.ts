...
export const FOODBEV_INDUSTRIES: IndustryNode[] = [
  ...
  { id: 'secondary.foodbev.food_truck', parentId: 'secondary.foodbev', sector: 'secondary', label: "Food & Beverage Production — Food Truck", naics: '3121', gics: '3020', tags: ["production","perishable"], defaultProductionMethod: 'batch', defaultArchetype: 'mid_market' },
];
