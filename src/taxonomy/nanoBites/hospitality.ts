...
export const HOSPITALITY_BITES: NanoBite[] = [
  ...
  { id: 'hosp.service.proximity_greeting', industryId: 'tertiary.hospitality', valueChainStage: 'service',     microElement: 'UWB Proximity',         task: 'Trigger J.D. Power-aligned greeting via UWB tag detection',           cadence: 'event', automatable: false, requiresTier: 'pro' },
  { id: 'hosp.ops.kitchen_telemetry',   industryId: 'tertiary.hospitality', valueChainStage: 'operations',    microElement: 'QSR Automation',         task: 'Monitor Speed-of-Service (SoS) via Elo Android telemetry',            cadence: 'event', automatable: true,  requiresTier: 'pro' },
  { id: 'hosp.infra.spatial_audit',     industryId: 'tertiary.hospitality', valueChainStage: 'infrastructure', microElement: 'LiDAR Mapping',         task: 'Update Property Management System (PMS) via iPhone 12/13 LiDAR scan', cadence: 'monthly', automatable: false, requiresTier: 'enterprise' },
];
